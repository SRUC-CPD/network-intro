...
It's worth repeating: Wickham 2014 is excellent <http://vita.had.co.nz/papers/tidy-data.pdf>.
...
Here we use `lty` to change the line type, use `?par` and search for `lty` to see other options.
